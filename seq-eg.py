...
for i in range(2000):
    ...
    for j in range(14):
        ...
        bla = copy.copy(switch(datas[i][j]))
...
model.add(Conv1D(128, kernel_size=3, strides=1, activation='relu', input_shape=(14, 128)))

model.add(Conv1D(256, kernel_size=3, strides=1, activation='relu', input_shape=(14, 256)))
